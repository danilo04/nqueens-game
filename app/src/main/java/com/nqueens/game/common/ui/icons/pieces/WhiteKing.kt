...
public val NQueensIcons.Pieces.WhiteKing: ImageVector
    get() {
        if (_whiteKing != null) {
            return _whiteKing!!
        }
        _whiteKing = Builder(name = "WhiteKing", defaultWidth = 636.0.dp, defaultHeight = 765.0.dp,
                viewportWidth = 636.0f, viewportHeight = 765.0f).apply {
            path(fill = linearGradient(0.0f to Color(0xFFF0F0F0), 1.0f to Color(0xFFFFFFFF), start =
                    Offset(320.22f,356.3f), end = Offset(320.22f,747.74f)), stroke = null,
            ...
            path(fill = linearGradient(0.0f to Color(0xFFF0F0F0), 1.0f to Color(0xFFFFFFFF), start =
                    Offset(324.12f,9.75f), end = Offset(324.12f,372.71f)), stroke = null,
                    strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
...
private var _whiteKing: ImageVector? = null

@Preview
@Composable
private fun Preview(): Unit {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = NQueensIcons.Pieces.WhiteKing, contentDescription = "")
    }
}
