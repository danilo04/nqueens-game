...
public val NQueensIcons.Pieces.BlackPawn: ImageVector
    get() {
        if (_blackPawn != null) {
            return _blackPawn!!
        }
        _blackPawn = Builder(name = "BlackPawn", defaultWidth = 636.0.dp, defaultHeight = 636.0.dp,
                viewportWidth = 636.0f, viewportHeight = 636.0f).apply {
            path(fill = linearGradient(0.0f to Color(0xFF000000), 1.0f to Color(0xFF1A1A1A), start =
            ...
            path(fill = linearGradient(0.0f to Color(0xFF000000), 1.0f to Color(0xFF1A1A1A), start =
                    ...
                    SolidColor(Color(0xFFffffff)), strokeLineWidth = 18.4296f, strokeLineCap = Butt,
...
private fun Preview(): Unit {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = NQueensIcons.Pieces.BlackPawn, contentDescription = "")
    }
}
