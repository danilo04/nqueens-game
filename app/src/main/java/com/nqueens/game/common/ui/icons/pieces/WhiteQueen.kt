...
public val NQueensIcons.Pieces.WhiteQueen: ImageVector
    get() {
        if (_whiteQueen != null) {
            return _whiteQueen!!
        }
        _whiteQueen = Builder(name = "WhiteQueen", defaultWidth = 636.0.dp, defaultHeight =
...
private fun Preview(): Unit {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = NQueensIcons.Pieces.WhiteQueen, contentDescription = "")
    }
}
