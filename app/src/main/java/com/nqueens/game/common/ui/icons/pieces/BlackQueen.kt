...
public val NQueensIcons.Pieces.BlackQueen: ImageVector
    get() {
        if (_blackQueen != null) {
            return _blackQueen!!
        }
        _blackQueen = Builder(name = "BlackQueen", defaultWidth = 636.0.dp, defaultHeight =
            ...
            path(fill = linearGradient(0.0f to Color(0xFF1A1A1A), 1.0f to Color(0xFF0D0D0D), start =
                    Offset(320.21f,227.3f), end = Offset(320.21f,618.74f)), stroke = null,
            ...
            path(fill = linearGradient(0.0f to Color(0xFF1A1A1A), 1.0f to Color(0xFF0D0D0D), start =
                    Offset(322.98f,27.64f), end = Offset(322.98f,287.79f)), stroke = null,
                    strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
...
private fun Preview(): Unit {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = NQueensIcons.Pieces.BlackQueen, contentDescription = "")
    }
}
