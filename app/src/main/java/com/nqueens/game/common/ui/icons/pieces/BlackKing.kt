...
public val NQueensIcons.Pieces.BlackKing: ImageVector
    get() {
        if (_blackKing != null) {
            return _blackKing!!
        }
        _blackKing = Builder(name = "BlackKing", defaultWidth = 636.0.dp, defaultHeight = 765.0.dp,
...
private var _blackKing: ImageVector? = null

@Preview
@Composable
private fun Preview(): Unit {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = NQueensIcons.Pieces.BlackKing, contentDescription = "")
    }
}
