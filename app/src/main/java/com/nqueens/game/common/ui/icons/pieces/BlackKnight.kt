...
public val NQueensIcons.Pieces.BlackKnight: ImageVector
    get() {
        if (_blackKnight != null) {
            return _blackKnight!!
        }
        _blackKnight = Builder(name = "Blackknight", defaultWidth = 636.0.dp, defaultHeight =
...
private var _blackKnight: ImageVector? = null

@Preview
@Composable
private fun Preview(): Unit {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = NQueensIcons.Pieces.BlackKnight, contentDescription = "")
    }
}
