...
public val NQueensIcons.Pieces.BlackBishop: ImageVector
    get() {
        if (_blackBishop != null) {
            return _blackBishop!!
        }
        _blackBishop = Builder(name = "BlackBishop", defaultWidth = 636.0.dp, defaultHeight =
...
private var _blackBishop: ImageVector? = null

@Preview
@Composable
private fun Preview(): Unit {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = NQueensIcons.Pieces.BlackBishop, contentDescription = "")
    }
}
