...
public val NQueensIcons.Pieces.WhiteRook: ImageVector
    get() {
        if (_whiteRook != null) {
            return _whiteRook!!
        }
        _whiteRook = Builder(name = "WhiteRook", defaultWidth = 636.0.dp, defaultHeight = 636.0.dp,
            ...
            path(fill = linearGradient(0.0f to Color(0xFFF0F0F0), 1.0f to Color(0xFFFFFFFF), start =
                    Offset(319.22f,30.71f), end = Offset(319.22f,236.51f)), stroke = null,
                    strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
...
private var _whiteRook: ImageVector? = null

@Preview
@Composable
private fun Preview(): Unit {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = NQueensIcons.Pieces.WhiteRook, contentDescription = "")
    }
}
